    ...
    public class EntityWithListOfEntityTypesPersistenceTests
    {
        ...
        private void Configure(Configuration cfg)
        {
            ...
            var auditEntryFactory = new SimpleAuditEntryFactoryBuilder()
                .MapEntity<OneToManyEntity, OneToManyEntityAuditHistory>(x => new OneToManyEntityAuditHistory { Id = x.Id, Value = x.Value })
                .MapEntity<EntityWithListOfEntityTypes, EntityWithListOfEntityTypesAuditHistory>(x => new EntityWithListOfEntityTypesAuditHistory { Id = x.Id })
                .Build();
