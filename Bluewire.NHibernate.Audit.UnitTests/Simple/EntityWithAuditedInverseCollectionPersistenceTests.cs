    ...
    public class EntityWithInverseCollectionPersistenceTests
    {
        ...
        private void Configure(Configuration cfg)
        {
            ...
            var auditEntryFactory = new SimpleAuditEntryFactoryBuilder()
                .MapEntity<EntityWithAuditedInverseCollection, EntityWithAuditedInverseCollectionAuditHistory>(x => new EntityWithAuditedInverseCollectionAuditHistory { Id = x.Id, Value = x.Value })
                .Build();
