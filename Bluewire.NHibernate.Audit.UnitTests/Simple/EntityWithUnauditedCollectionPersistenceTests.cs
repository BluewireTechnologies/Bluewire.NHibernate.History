    ...
    public class EntityWithUnauditedCollectionPersistenceTests
    {
        ...
        private void Configure(Configuration cfg)
        {
            ...
            var auditEntryFactory = new SimpleAuditEntryFactoryBuilder()
                .MapEntity<EntityWithUnauditedCollection, EntityWithUnauditedCollectionAuditHistory>(x => new EntityWithUnauditedCollectionAuditHistory { Id = x.Id, Value = x.Value })
                .Build();
