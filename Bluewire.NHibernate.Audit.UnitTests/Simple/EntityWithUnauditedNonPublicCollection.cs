...
{
    [AuditableEntity(typeof(EntityWithUnauditedNonPublicCollectionAuditHistory))]
    public class EntityWithUnauditedNonPublicCollection
    {
        public EntityWithUnauditedNonPublicCollection()
        {
    ...
    public class EntityWithUnauditedNonPublicCollectionAuditHistory : EntityAuditHistoryBase<int, int>
    {
        public virtual string Value { get; set; }
    }
}
